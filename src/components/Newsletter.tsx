  ...
  return (
    <div className="bg-bpyellowdark py-8">
      ...
      <div className="w-[70%] mx-auto ">
        ...
        <p className="text-responsivetext text-bpblack mt-6 font-medium ">By clicking Subscribe, I agree that Heirs Holdings may use my contact details to send me communications and I consent to the Terms as provided in the Privacy Policy and Data Collection Clause.</p>
