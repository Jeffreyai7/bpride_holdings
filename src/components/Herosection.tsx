...
const Herosection = () => {
  ...
  return (
    <div className="relative left-0 right-0 overflow-hidden ">
        ...
        <div className="absolute bottom-48 z-10 opacity-70 w-[44.5rem] h-[46rem] md:w-[89.5rem] md:h-[92.3rem] shadow-large"><img src="src\assets\images\Ellipseb.png" alt="" /></div>
